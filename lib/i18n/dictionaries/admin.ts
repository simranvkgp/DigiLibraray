...
export const admin = {
  en: {
    ...
    "admin.users.col.idCard": "ID card",
    "admin.users.viewIdCard": "View ID card",
    ...
    "admin.books.form.driveLink": "Book source link",
    "admin.books.form.driveLinkHint": "Paste a Google Drive share link, or a direct/live link to the file.",
    ...
    "admin.requests.col.institutionBoard": "Institution / Board",
  ...
  hi: {
    ...
    "admin.users.col.idCard": "आईडी कार्ड",
    "admin.users.viewIdCard": "आईडी कार्ड देखें",
    ...
    "admin.books.form.driveLink": "बुक सोर्स लिंक",
    "admin.books.form.driveLinkHint": "Google Drive शेयर लिंक पेस्ट करें, या फ़ाइल का डायरेक्ट/लाइव लिंक।",
