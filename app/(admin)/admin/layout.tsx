...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const [pendingRequestCount, pendingSuggestionCount, pendingUserCount] = await Promise.all([
  ...
  const modules: AdminNavModule[] = [
    ...
    { href: "/admin/requests", label: t("admin.nav.requests"), icon: "Inbox", badge: pendingRequestCount + pendingSuggestionCount, group: t("admin.nav.group.content") },
