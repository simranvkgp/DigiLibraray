...
export default async function LoginPage() {
  ...
  return (
    <div className="min-h-dvh border-r-[10px] border-t-[10px] border-navy bg-cream">
      <main className="mx-auto grid min-h-dvh max-w-[2560px] lg:grid-cols-[7fr_5fr] lg:gap-x-[clamp(2rem,4vw,7rem)]">
        ...
        <div className="flex items-start justify-center px-6 py-12 sm:px-10 lg:items-center lg:justify-center lg:pl-6 lg:pr-6 xl:pl-8 xl:pr-8">
